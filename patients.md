...
1. **Check in for a visit:** [clinic check-in demo](https://smart-health-checkin.org/client/demo/#wallet=demo). Press **Continue with Demo wallet**, choose what to share in the Demo wallet, and press **Share selected**.
2. **Fill in a form from your health app:** [form autofill demo](https://smart-health-checkin.org/client/demo/autofill.html#wallet=demo). Press **Continue with Demo wallet**, share, and look over what was filled in.
...
4. **Optional, on an Android phone:** try a real wallet app. Follow the [install steps](scenarios.html#reference-android-wallet), then check in from the [clinic check-in demo](https://smart-health-checkin.org/client/demo/) in Chrome: press **Use an app on this phone** and pick the app.
...
Send a short report from the [patient track](share.html#patients) of the share page: it has the guide prompt for any AI assistant, and the experience form. Reports are public, credited with the name and organization you give, or anonymous if you leave those blank, so leave out anything you wouldn't want public.
